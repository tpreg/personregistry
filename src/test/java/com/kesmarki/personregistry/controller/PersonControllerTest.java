...
public class PersonControllerTest {
	...
	public void savePerson_ValidData_Success() throws Exception {
		final var inputDto = new PersonDto("Cserepes Virág", LocalDate.of(1991, 10, 2), "Hungary", null, null);
		final var outputDto = new PersonDto("Cserepes Virág", LocalDate.of(1991, 10, 2), "Hungary", null, null);
